...
while True:
    ...
    while command:
        ...
        print(fur)
        if fur == 'U':
            if lst[x - 1][y] != '#' and (lst[x - 1][y] != 'b' and lst[x - 1][y] != 'B'):
                lst[x][y] = '.'
                x = x - 1
                lst[x][y] = 'w'
            if lst[x - 1][y] != '#' :
                if (lst[x - 1][y] == 'b' and lst[x - 2][y] != 'b' and lst[x - 2][y] != 'B'):
                    lst[x][y] = '.'
                    x = x - 1
                    lst[x][y] = 'w'
                    lst[x-1][y] = 'b'
                
                elif (lst[x - 1][y] == 'B' and lst[x - 2][y] != 'B' and lst[x - 2][y] != 'b'):
                    lst[x][y] = '.'
                    x = x - 1
                    lst[x][y] = 'w'
                    lst[x - 1][y] = 'b'

            if lst[x - 1][y] != '#' and lst[x - 2][y] != '#' and lst[x - 1][y] == 'b' and lst[x - 2][y] != 'b':
                lst[x][y] = '.'
                x = x - 1
                if lst[x - 1][y] == '+':
                    lst[x - 1][y] = 'B'
        ...
        #         else:
        #             lst[x][y] = 'w'
        #     elif lst[x][y + 1] != '#' and lst[x][y + 2] != '#' and lst[x][y + 1] == 'b' and lst[x][y + 2] != 'b' and lst[x][y + 2] != 'B':
        #         if lst[x][y] == 'W':
        #             lst[x][y] = '+'
        #         y += 1
        #         lst[x][y] = 'w'
        ...
        #
        # if fur == 'D':
        #     if lst[x + 1][y] != '#' and (lst[x + 1][y] != 'b' and lst[x + 2][y] != 'b' and lst[x + 1][y] != 'B' and lst[x + 2][y] != 'B'):
        #         lst[x][y] = '.'
        #         x = x + 1
        #         lst[x][y] = 'w'
        #     elif lst[x + 1][y] != '#' and (lst[x + 1][y] != 'b'  and lst[x + 1][y] != 'B' and (lst[x + 2][y] == 'b' or lst[x + 2][y] == 'B')):
        #         lst[x][y] = '.'
        #         x = x + 1
        #         lst[x][y] = 'w'
        #     elif lst[x + 1][y] != '#' and lst[x + 2][y] != '#' and lst[x + 1][y] == 'b' and lst[x + 2][y] != 'b':
        ...
        #             lst[x][y] = 'w'
        #
        #     elif lst[x + 1][y] != '#' and lst[x + 2][y] != '#' and lst[x + 1][y] == 'B' and (lst[x + 2][y] != 'b' or lst[x + 2][y] != 'B'):
        #         x = x + 1
        #         lst[x - 1][y] = '.'
        #         lst[x][y] = 'W'
        #         lst[x + 1][y] ='b'
